...
func (t *Token) New() common.TokenInfo {
	return NewToken()
}
...
func (t *Token) GetCodeChallengeMethod() common.CodeChallengeMethod {
	return common.CodeChallengeMethod(t.CodeChallengeMethod)
}

// SetCodeChallengeMethod challenge method
func (t *Token) SetCodeChallengeMethod(method common.CodeChallengeMethod) {
