...
func NewMemoryTokenStore() (common.TokenStore, error) {
	return NewFileTokenStore(":memory:")
}

// NewFileTokenStore create a token store instance based on file
func NewFileTokenStore(filename string) (common.TokenStore, error) {
...
func (ts *TokenStore) Create(ctx context.Context, info common.TokenInfo) error {
	ct := time.Now()
...
func (ts *TokenStore) getData(key string) (common.TokenInfo, error) {
	var ti common.TokenInfo
...
func (ts *TokenStore) GetByCode(ctx context.Context, code string) (common.TokenInfo, error) {
	return ts.getData(code)
}

// GetByAccess use the access token for token information data
func (ts *TokenStore) GetByAccess(ctx context.Context, access string) (common.TokenInfo, error) {
...
func (ts *TokenStore) GetByRefresh(ctx context.Context, refresh string) (common.TokenInfo, error) {
