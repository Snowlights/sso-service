...
import "github.com/Snowlights/sso-service/common"
...
func (s *Server) SetAllowedResponseType(types ...common.ResponseType) {
	s.Config.AllowedResponseTypes = types
}

// SetAllowedGrantType allow the grant types
func (s *Server) SetAllowedGrantType(types ...common.GrantType) {
