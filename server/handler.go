...
type (
	...
	ClientAuthorizedHandler func(clientID string, grant common.GrantType) (allowed bool, err error)

	// ClientScopeHandler check the client allows to use scope
	ClientScopeHandler func(tgr *common.TokenGenerateRequest) (allowed bool, err error)
	...
	RefreshingScopeHandler func(tgr *common.TokenGenerateRequest, oldScope string) (allowed bool, err error)

	// RefreshingValidationHandler check if refresh_token is still valid. eg no revocation or other
	RefreshingValidationHandler func(ti common.TokenInfo) (allowed bool, err error)

	// ResponseErrorHandler response error handing
	ResponseErrorHandler func(re *common.Response)

	// InternalErrorHandler internal error handing
	InternalErrorHandler func(err error) (re *common.Response)
	...
	ExtensionFieldsHandler func(ti common.TokenInfo) (fieldsValue map[string]interface{})
...
func ClientFormHandler(r *http.Request) (string, string, error) {
	...
	if clientID == "" {
		return "", "", common.ErrInvalidClient
	}
