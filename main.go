...
import (
	...
	"github.com/Snowlights/sso-service/manage"
	"github.com/Snowlights/sso-service/model"
	"github.com/Snowlights/sso-service/server"
	"github.com/Snowlights/sso-service/store"
...
func main() {
	...
	clientStore.Set(idvar, &model.Client{
		ID:     idvar,
		Secret: secretvar,
		Domain: domainvar,
	})
	...
	srv.SetInternalErrorHandler(func(err error) (re *common.Response) {
		log.Println("Internal Error:", err.Error())
		return
	})

	srv.SetResponseErrorHandler(func(re *common.Response) {
...
func loginHandler(w http.ResponseWriter, r *http.Request) {
	...
	outputHTML(w, r, "C://Users//zhangwei18//Desktop//self/oauth2/example/server/static/login.html")
}
...
func authHandler(w http.ResponseWriter, r *http.Request) {
	...
	outputHTML(w, r, "C://Users//zhangwei18//Desktop//self/oauth2/example/server/static/auth.html")
}
